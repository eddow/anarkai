import { type HexBoard, isTileCoord } from 'ssh/src/lib/board'
import type { Alveolus } from 'ssh/src/lib/board/content/alveolus'
import { assert, namedEffect } from 'ssh/src/lib/debug'
import type { Character } from 'ssh/src/lib/population/character'
import type { IdlePlan, PickupPlan, Plan, TransferPlan, WorkPlan } from 'ssh/src/lib/types/base'
import { gameObjectsModule } from 'ssh/src/lib/types/game-objects'
import { type Positioned, toAxialCoord } from 'ssh/src/lib/utils'
