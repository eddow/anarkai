 ...
 */
export const findPath = wrapInert(function findPath(
 ...
 */
export const findNearest = wrapInert(function findNearest<_T>(
	getNeighbors: GetNeighbors,
	start: Positioned,
	isGoal: Scoring<true>,
 ...
 * @returns Path to the nearest valid goal if found within maxTime, undefined otherwise
 */
export const findBest = wrapInert(function findBest<_T>(
	getNeighbors: GetNeighbors,
	start: Positioned,
