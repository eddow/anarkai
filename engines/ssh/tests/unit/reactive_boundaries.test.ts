...
describe('Reactive boundaries', () => {
	...
	it('harvest demand getter invalidates when hive advertisements change', async () => {
	...
	it('findBestJob remains a momentaneous query across hive demand changes', async () => {
