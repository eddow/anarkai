...
The "mana" equivalent is trust. Trust is acquired by happiness (happiness = delta-trust) and is used in one-shot edicts
...
Nudging spontaneous district spawn (shop/residence/...) by artificially specifying a high need of goods to trade or planing a high increase of population, so nudging a lot of houses to build